 ...
 */
(function(r,t,l){var u={required:"El campo %s es requerido.",matches:"The %s field does not match the %s field.","default":"The %s field is still set to default, please change.",valid_email:"The %s field must contain a valid email address.",valid_emails:"The %s field must contain all valid email addresses.",min_length:"El campo %s debe contener al menos %s caracteres de longitud.",max_length:"El campo %s no debe exceder de %s caracteres de longitud.",exact_length:"El campo %s debe poseer exactamente %s caracteres de longitud.",
greater_than:"El campo %s debe contener un número mayor que %s.",less_than:"El campo %s debe contener un número menor a %s.",alpha:"The %s field must only contain alphabetical characters.",alpha_numeric:"The %s field must only contain alpha-numeric characters.",alpha_dash:"The %s field must only contain alpha-numeric characters, underscores, and dashes.",numeric:"El campo %s debe contener solamente números.",integer:"The %s field must contain an integer.",decimal:"El campo %s debe contener un número decimal.",
is_natural:"El campo %s debe contener únicamente números positivos.",is_natural_no_zero:"The %s field must contain a number greater than zero.",valid_ip:"The %s field must contain a valid IP.",valid_base64:"The %s field must contain a base64 string.",valid_credit_card:"The %s field must contain a valid credit card number.",is_file_type:"The %s field must contain only %s files.",valid_url:"The %s field must contain a valid URL.",greater_than_date:"The %s field must contain a more recent date than %s.",less_than_date:"The %s field must contain an older date than %s.",
